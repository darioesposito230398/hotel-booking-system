...
const translations = {
  it: {
    ...
    'payment.paypal.desc': 'Non paghi subito: autorizzi l\'acconto della prima notte, che verrà addebitato solo quando confermiamo la prenotazione. Il resto si paga in struttura.',
  ...
  en: {
    ...
    'payment.paypal': 'PayPal',
    'payment.paypal.desc': 'You don\'t pay now: you authorize the first-night deposit, charged only when we confirm the booking. The balance is paid on site.',
