...
const translations = {
  it: {
    ...
    'payment.card.desc': 'Addebitiamo solo la prima notte (acconto). Il resto si paga in struttura.',
  ...
  en: {
    ...
    'payment.card.desc': 'We only charge the first night (deposit). The balance is paid on site.',
