...
const translations = {
  it: {
    ...
    'payment.paypal.desc': 'Paghi subito l\'acconto della prima notte (il resto si paga in struttura). Puoi pagare anche con carta, senza conto PayPal.',
    ...
    'success.paypal': 'Grazie! L\'acconto della prima notte è stato pagato con PayPal. Il resto si paga in struttura.',
  ...
  en: {
    ...
    'payment.paypal': 'PayPal',
    'payment.paypal.desc': 'Pay the first-night deposit now (the balance is paid on site). You can also pay with a card, no PayPal account needed.',
    ...
    'success.paypal': 'Thank you! Your first-night deposit was paid with PayPal. The balance is paid on site.',
