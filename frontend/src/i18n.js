...
const translations = {
  it: {
    ...
    'payment.bonifico.desc': 'Paghi con bonifico istantaneo solo dopo la nostra conferma: prima verifichiamo la disponibilità, poi ricevi una email con le coordinate bancarie.',
    ...
    'bonifico.title': 'Come funziona il pagamento con bonifico',
    'bonifico.iban.pending': 'Prima verifichiamo la disponibilità della camera: riceverai una email con le coordinate bancarie (intestatario e IBAN) e l\'importo dell\'acconto della prima notte da versare.',
    'bonifico.note': 'La prenotazione verrà confermata solo quando il bonifico risulterà ricevuto. Nessun addebito avviene prima della pre-conferma.',
  ...
  en: {
    ...
    'payment.bonifico.desc': 'Pay by instant bank transfer only after we confirm: first we check availability, then you receive an email with the bank details.',
    ...
    'bonifico.title': 'How bank transfer payment works',
    'bonifico.iban.pending': 'First we check room availability: you will receive an email with the bank details (payee and IBAN) and the first-night deposit amount to transfer.',
    'bonifico.note': 'The booking is confirmed only when the transfer is received. No charge occurs before the pre-confirmation.',
