...
'service.wifi.d': 'Connessione Wi-Fi in tutte le stanze e nelle aree comuni',
    'service.breakfast.t': 'Colazione su richiesta',
    'service.breakfast.d': 'Al bar convenzionato',
    'service.luggage.d': 'Nell\'orario della reception, dalle 9 alle 19',
    'service.cleaning.t': 'Pulizia giornaliera',
    'service.cleaning.d': 'Camere e cambio biancheria',
    'service.ac.t': 'Aria condizionata',
    'service.ac.d': 'In tutte le camere',
    'service.checkin.t': 'Check-in tardivo',
    'service.checkin.d': 'Possibilità di check-in tardivo con codice, su richiesta',
    ...
    'idDocument.hint': 'Carica una foto o un PDF del documento (max 5 MB).',
    ...
    'price.firstnight.pre': 'Acconto prima notte:',
    'price.firstnight.post': 'Il resto si paga in struttura.',
    'payment.paypal': 'PayPal',
    'payment.paypal.desc': 'Non paghi ora: autorizzi solo l\'acconto della prima notte, che addebitiamo quando confermiamo la prenotazione. Il resto si paga all\'arrivo.',
    'payment.bonifico': 'Bonifico istantaneo',
    'payment.bonifico.desc': 'Non paghi ora. Dopo la richiesta verifichiamo la disponibilità e ti inviamo via email l\'IBAN e l\'importo dell\'acconto (prima notte) da versare. La prenotazione si conferma al ricevimento del bonifico.',
    ...
    'bonifico.title': 'Come funziona il bonifico',
    'bonifico.iban.pending': '1. Invia la richiesta → 2. verifichiamo la disponibilità → 3. ricevi una email con IBAN, intestatario e l\'importo dell\'acconto (prima notte) da versare.',
    'bonifico.note': 'La prenotazione è confermata solo quando il bonifico risulta ricevuto: non ti addebitiamo nulla prima della pre-conferma.',
    ...
    'success.bonifico.done': 'Richiesta inviata. Ora verifichiamo la disponibilità: riceverai una email con le coordinate bancarie e l\'importo dell\'acconto della prima notte da versare.',
    'success.bonifico.confirm': 'Confermeremo la prenotazione quando il bonifico risulterà ricevuto.',
...
'service.wifi.d': 'Free Wi-Fi in every room and in the common areas',
    'service.breakfast.t': 'Breakfast on request',
    'service.breakfast.d': 'At our partner bar',
    'service.luggage.d': 'During reception hours, from 9 am to 7 pm',
    'service.cleaning.t': 'Daily housekeeping',
    'service.cleaning.d': 'Room cleaning and linen change',
    'service.ac.t': 'Air conditioning',
    'service.ac.d': 'In every room',
    'service.checkin.t': 'Late check-in',
    'service.checkin.d': 'Late check-in with access code, on request',
    ...
    'idDocument.hint': 'Upload a photo or PDF of the document (max 5 MB).',
    ...
    'price.firstnight.pre': 'First-night deposit:',
    'price.firstnight.post': 'The balance is paid at the property.',
    'payment.paypal': 'PayPal',
    'payment.paypal.desc': 'You don\'t pay now: you only authorize the first-night deposit, which we charge when we confirm the booking. The balance is paid on arrival.',
    'payment.bonifico': 'Instant bank transfer',
    'payment.bonifico.desc': 'You don\'t pay now. After your request we check availability and email you the IBAN and the first-night deposit amount. The booking is confirmed once the transfer is received.',
    ...
    'bonifico.title': 'How the bank transfer works',
    'bonifico.iban.pending': '1. Send the request → 2. we check availability → 3. you receive an email with the IBAN, payee and the first-night deposit amount to transfer.',
    'bonifico.note': 'The booking is confirmed only when the transfer is received: we charge nothing before the pre-confirmation.',
    ...
    'success.bonifico.done': 'Request sent. We are now checking availability: you will receive an email with the bank details and the first-night deposit amount to transfer.',
    'success.bonifico.confirm': 'We will confirm the booking once the transfer is received.',
